        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-xl shadow-lg p-6">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="<?php echo $base_url; ?>/student/complaints.php" class="text-blue-600 hover:text-blue-700 font-medium">
                    ...
                    <?php if (empty($recent_complaints)): ?>
                        <div class="text-center py-8">
                            ...
                            <a href="<?php echo $base_url; ?>/student/submit.php" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors">
                                    ...
                                    <div class="flex items-start justify-between">
                                        <div class="flex-1">
                                            <h3 class="font-semibold text-gray-900 mb-1">
                                                <a href="<?php echo $base_url; ?>/student/complaint.php?id=<?php echo $complaint['id']; ?>" class="hover:text-blue-600">
            ...
            <div class="space-y-8">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6">
                    ...
                    <div class="space-y-4">
                        <a href="<?php echo $base_url; ?>/student/submit.php" class="block w-full bg-blue-600 text-white text-center py-3 rounded-lg hover:bg-blue-700 transition-colors">
                            <i class="fas fa-plus mr-2"></i>Submit New Complaint
                        </a>
                        <a href="<?php echo $base_url; ?>/student/complaints.php" class="block w-full bg-gray-100 text-gray-700 text-center py-3 rounded-lg hover:bg-gray-200 transition-colors">
                            <i class="fas fa-list mr-2"></i>View All Complaints
                        </a>
                        <a href="<?php echo $base_url; ?>/student/profile.php" class="block w-full bg-gray-100 text-gray-700 text-center py-3 rounded-lg hover:bg-gray-200 transition-colors">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="<?php echo $base_url; ?>/student/notifications.php" class="text-blue-600 hover:text-blue-700 font-medium">
                            View All
                        </a>
                    </div>
