        ...
        if (!$error) {
            ...
            if ($stmt->execute()) {
                ...
                foreach ($admins as $admin) {
                    ...
                    $notif_message = $_SESSION['full_name'] . ' submitted a new ' . $category . ' complaint: ' . $title;
...
$page_title = 'Submit Complaint - Student Portal';
        ...
        <div class="bg-white rounded-xl shadow-lg p-8">
            <?php if ($success): ?>
                <div class="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg mb-6">
                    ...
                    <?php echo $success; ?>
                    <div class="mt-2">
                        <a href="<?php echo $base_url; ?>/student/complaints.php" class="text-green-800 hover:text-green-900 font-medium">
