        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-xl shadow-lg p-8">
                    ...
                    <form method="POST" class="space-y-6">
                        ...
                        <div class="flex items-center justify-between pt-6 border-t">
                            <a href="<?php echo $base_url; ?>/student/dashboard.php" class="text-gray-600 hover:text-gray-700">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6">
                    ...
                    <div class="space-y-3">
                        <a href="<?php echo $base_url; ?>/student/submit.php" class="block w-full bg-blue-600 text-white text-center py-2 rounded-lg hover:bg-blue-700 transition-colors">
                            <i class="fas fa-plus mr-2"></i>Submit Complaint
                        </a>
                        <a href="<?php echo $base_url; ?>/student/complaints.php" class="block w-full bg-gray-100 text-gray-700 text-center py-2 rounded-lg hover:bg-gray-200 transition-colors">
                            <i class="fas fa-list mr-2"></i>View Complaints
                        </a>
                        <a href="<?php echo $base_url; ?>/student/notifications.php" class="block w-full bg-gray-100 text-gray-700 text-center py-2 rounded-lg hover:bg-gray-200 transition-colors">
